...
có đường dẫn tuyệt đối hoặc file dữ liệu riêng phụ thuộc máy của thành
viên~\cite{sklearn-dataset}.
...
feature đầu vào. Theo mô tả dataset, giá trị ``worst'' là trung bình của ba giá
trị lớn nhất của feature tương ứng trên mỗi ảnh, không phải một phép đo cực đại
đơn lẻ.
...
phép chia theo ngưỡng. Quy mô 569 mẫu phù hợp với phạm vi thí nghiệm học thuật:
đủ để minh họa quá trình xây dựng cây và cross-validation nhưng vẫn cho phép
trực quan hóa. Tuy nhiên, kết quả trên một train/test split không được xem là
bằng chứng cho hiệu quả lâm sàng. Các rule như
